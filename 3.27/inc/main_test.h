...
#define arduino 1 //
#define n_accel 1280 // minimum - 512 // acceleration size post digitisation
#define dt 0.5 // 2 Hz
#define dt_raw 0.125 // 8 Hz
#define dt_raw64 0.015625 //
#define n_raw 5120 //(int)(n_accel/(dt_raw/dt))  // size of raw data
#define n_raw64 40960 //(int)(n_accel/(dt_raw64/dt))  // size of raw 64 Hz data
#define n_accelfft 2048
//#define n_psd 55 // size psd after frequency averaging
//#define n_mom 7 // no. of moments calculated
//#define n_calib 4  // no. of values read from calibrate.in
//#define g 9.80665 // gravity of earth m/s^2
//#define pi 3.141592653589793
//#define rmv_ramp 1 // 1 = first 2000 pts of raw data zero
//#define std_kist_min .1
//#define rspns_f1 0.01 // response cut off minimum frequency first look
//#define rspns_f2 0.02 // response cut off maximum frequency first look
//#define rspns_f3 0.03 // response cut off maximum frequency default backup
//#define rspns_f4 0.04 // response cut off maximum frequency default backup
//#define rspns_f5 0.03 // high frequency noise segment maximum frequency - pd.c
//#define rspns_f6 0.5  // low frequency noise segment minimum frequency  - pd.c
//#define rspns_f7 0.04 // Lower bound for directional analysis (Hz) - direction.c
//#define rspns_f8 0.25 // Upper bound for directional analysis (Hz) - direction.c
//#define std_yaw_limit 1.0 // Min yaw standard deviation for open water flag
//#define nstd_kist 3 // Standard deviation multiplier in despike
//#define nstd_imu 6 // Standard deviation multiplier in despike
//#define nstd_magno 6 // Standard deviation multiplier in despike
//#define nstd_gyro 6 // Standard deviation multiplier in despike
//#define nstd_pos 6 // Standard deviation multiplier in despike
//#define noise_factor 0.2 // Noise factor in identify_low_frequency_noise
//#define declination 17.08674 // Arctic
//#define declination 0.0 // if not sure - can do it post data collection
